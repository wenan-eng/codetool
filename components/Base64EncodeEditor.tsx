...
import { base64EncodeText, base64DecodeText } from "@/lib/base64TextCodec"
...
const SAMPLES: Record<string, string> = {
  zh: "你好 hello Base64 123",
  en: "Hello world Base64 123",
  es: "Hola mundo Base64 123",
}
...
const DEFAULT_TEXTS: Record<string, Record<string, string>> = {
  zh: {
    encode: "Base64 编码",
    decode: "Base64 解码",
    inputPlaceholder: "请输入要进行 Base64 编码/解码的文本内容...",
    outputPlaceholder: "这里用于显示 Base64 编码或解码的结果",
    sample: "查看示例",
    copy: "复制结果",
    clear: "清空数据",
    copied: "已复制",
  ...
  en: {
    ...
    inputPlaceholder: "Enter text to encode/decode with Base64...",
    outputPlaceholder: "The Base64 encoding or decoding result will appear here",
    sample: "Sample",
    copy: "Copy Result",
    clear: "Clear",
    copied: "Copied",
  ...
  es: {
    encode: "Codificar Base64",
    decode: "Decodificar Base64",
    inputPlaceholder: "Introduzca el texto para codificar/decodificar en Base64...",
    outputPlaceholder: "Aquí se mostrará el resultado de la codificación o decodificación Base64",
    sample: "Ejemplo",
...
export default function Base64EncodeEditor({ locale = "zh" }: { locale?: string }) {
  const raw = (messagesMap[locale] || zh)?.base64Encode || {}
